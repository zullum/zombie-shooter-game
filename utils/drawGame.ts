...
const COOLDOWN_RADIUS = 20; // Increased from 15 to 20
const COOLDOWN_STROKE_WIDTH = 3;
const MATH_BLOCK_HIT_COOLDOWN_POSITIVE = 200; // ms, adjust as needed
const MATH_BLOCK_HIT_COOLDOWN_NEGATIVE = 50; // ms, adjust as needed
const LOCKER_SIZE = 24; // Slightly increased from 20 to 24 for better visibility
...
function drawEnhancedMathBlock(ctx: CanvasRenderingContext2D, block: any, gameSize: { width: number; height: number }, currentTime: number) {
